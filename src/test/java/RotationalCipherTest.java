import org.example.RotationalCipher;
...
public class RotationalCipherTest {
    ...
    @Test
    public void transformSmallLetter(){
        rotationalCipher = new RotationalCipher(0);
        Assert.assertEquals((char)rotationalCipher.transformSmallLetter('z',2), (char)'b');
    }

    @Test
    public void transformSmallLetterNotLoop(){
        rotationalCipher = new RotationalCipher(0);
        Assert.assertEquals((char)rotationalCipher.transformSmallLetter('a',2), (char)'c');
    }
